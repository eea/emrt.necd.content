...
class IConclusion(form.Schema, IImageScaleTraversable):
    ...
    closing_reason = schema.Choice(
        ...
        vocabulary='emrt.necd.content.conclusionreasons',
        required=True,
...
class Conclusion(dexterity.Container):
    ...
    def reason_value(self):
        return self._vocabulary_value('emrt.necd.content.conclusionreasons',
            self.closing_reason
        )
...
class AddForm(dexterity.AddForm):
    grok.name('emrt.necd.content.conclusion')
    grok.context(IConclusion)
    grok.require('emrt.necd.content.AddConclusion')
